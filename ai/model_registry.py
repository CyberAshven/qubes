...
class ModelRegistry:
    ...
    MODELS: Dict[str, Dict[str, Any]] = {
        ...
        "gpt-5.1-chat-latest": {"provider": "openai", "class": OpenAIModel, "description": "GPT-5.1 Chat", "cost_per_1k_tokens": 0.008},
        "gpt-5-turbo": {"provider": "openai", "class": OpenAIModel, "description": "GPT-5 Turbo", "cost_per_1k_tokens": 0.006},
        "gpt-5": {"provider": "openai", "class": OpenAIModel, "description": "GPT-5, Aug 2025", "temperature_fixed": 1.0, "cost_per_1k_tokens": 0.010},
        "gpt-5-mini": {"provider": "openai", "class": OpenAIModel, "description": "GPT-5 Mini", "cost_per_1k_tokens": 0.002},
        "gpt-4.1": {"provider": "openai", "class": OpenAIModel, "description": "GPT-4.1, 1M context", "cost_per_1k_tokens": 0.008},
        "gpt-4.1-mini": {"provider": "openai", "class": OpenAIModel, "description": "GPT-4.1 Mini", "cost_per_1k_tokens": 0.002},
        "gpt-4o": {"provider": "openai", "class": OpenAIModel, "description": "GPT-4o, multimodal", "cost_per_1k_tokens": 0.005},
        "gpt-4o-mini": {"provider": "openai", "class": OpenAIModel, "description": "GPT-4o Mini, 128k context", "cost_per_1k_tokens": 0.0004},
        "o4": {"provider": "openai", "class": OpenAIModel, "description": "O4, 2025", "temperature_fixed": 1.0, "cost_per_1k_tokens": 0.020},
        "o4-mini": {"provider": "openai", "class": OpenAIModel, "description": "O4 Mini, 2025", "temperature_fixed": 1.0, "cost_per_1k_tokens": 0.006},
        "o3-mini": {"provider": "openai", "class": OpenAIModel, "description": "O3 Mini", "temperature_fixed": 1.0, "cost_per_1k_tokens": 0.004},
        "o1": {"provider": "openai", "class": OpenAIModel, "description": "O1", "temperature_fixed": 1.0, "cost_per_1k_tokens": 0.015},

        # Anthropic - Claude 4 generation (2025)
        "claude-sonnet-4-5-20250929": {"provider": "anthropic", "class": AnthropicModel, "description": "Claude 4.5 Sonnet, Sep 2025", "cost_per_1k_tokens": 0.009},
        "claude-opus-4-1-20250805": {"provider": "anthropic", "class": AnthropicModel, "description": "Claude 4.1 Opus, Aug 2025", "cost_per_1k_tokens": 0.045},
        "claude-opus-4-20250514": {"provider": "anthropic", "class": AnthropicModel, "description": "Claude 4 Opus, May 2025", "cost_per_1k_tokens": 0.045},
        ...
        "gemini-3-flash-preview": {"provider": "google", "class": GoogleModel, "description": "Gemini 3 Flash Preview", "cost_per_1k_tokens": 0.001},
        "gemini-3-pro-image-preview": {"provider": "google", "class": GoogleModel, "description": "Gemini 3 Pro Image Preview", "cost_per_1k_tokens": 0.004},
        "gemini-2.5-pro": {"provider": "google", "class": GoogleModel, "description": "Gemini 2.5 Pro", "cost_per_1k_tokens": 0.003},
        "gemini-2.5-flash": {"provider": "google", "class": GoogleModel, "description": "Gemini 2.5 Flash", "cost_per_1k_tokens": 0.0005},
        "gemini-2.5-flash-preview-09-2025": {"provider": "google", "class": GoogleModel, "description": "Gemini 2.5 Flash Preview, Sep 2025", "cost_per_1k_tokens": 0.0005},
        ...
        "sonar": {"provider": "perplexity", "class": PerplexityModel, "description": "Sonar, Llama 3.3 based", "cost_per_1k_tokens": 0.001},
        "sonar-reasoning-pro": {"provider": "perplexity", "class": PerplexityModel, "description": "Sonar Reasoning Pro", "cost_per_1k_tokens": 0.005},
        "sonar-reasoning": {"provider": "perplexity", "class": PerplexityModel, "description": "Sonar Reasoning", "cost_per_1k_tokens": 0.002},
        "sonar-deep-research": {"provider": "perplexity", "class": PerplexityModel, "description": "Sonar Deep Research", "cost_per_1k_tokens": 0.008},
        ...
        "venice-uncensored": {"provider": "venice", "class": VeniceModel, "description": "Venice Uncensored 1.1 (Dolphin)", "cost_per_1k_tokens": 0.0005},
        "llama-3.3-70b": {"provider": "venice", "class": VeniceModel, "description": "Llama 3.3 70B via Venice", "cost_per_1k_tokens": 0.001},
        "llama-3.2-3b": {"provider": "venice", "class": VeniceModel, "description": "Llama 3.2 3B via Venice", "cost_per_1k_tokens": 0.0002},
        "qwen3-235b-a22b-instruct-2507": {"provider": "venice", "class": VeniceModel, "description": "Qwen3 235B Instruct via Venice", "cost_per_1k_tokens": 0.003},
        "qwen3-235b-a22b-thinking-2507": {"provider": "venice", "class": VeniceModel, "description": "Qwen3 235B Thinking via Venice", "cost_per_1k_tokens": 0.003},
        "qwen3-next-80b": {"provider": "venice", "class": VeniceModel, "description": "Qwen3 Next 80B via Venice", "cost_per_1k_tokens": 0.002},
        "qwen3-coder-480b-a35b-instruct": {"provider": "venice", "class": VeniceModel, "description": "Qwen3 Coder 480B via Venice", "cost_per_1k_tokens": 0.004},
        "qwen3-4b": {"provider": "venice", "class": VeniceModel, "description": "Qwen3 4B via Venice", "cost_per_1k_tokens": 0.0002},
        "mistral-31-24b": {"provider": "venice", "class": VeniceModel, "description": "Mistral 3.1 24B via Venice", "cost_per_1k_tokens": 0.0008},
        "claude-opus-45": {"provider": "venice", "class": VeniceModel, "description": "Claude Opus 4.5 via Venice", "cost_per_1k_tokens": 0.050},
        "openai-gpt-52": {"provider": "venice", "class": VeniceModel, "description": "GPT-5.2 via Venice", "cost_per_1k_tokens": 0.018},
        "openai-gpt-oss-120b": {"provider": "venice", "class": VeniceModel, "description": "OpenAI GPT OSS 120B via Venice", "cost_per_1k_tokens": 0.002},
        "venice/gemini-3-pro": {"provider": "venice", "class": VeniceModel, "description": "Gemini 3 Pro via Venice", "cost_per_1k_tokens": 0.005},
        "venice/gemini-3-flash": {"provider": "venice", "class": VeniceModel, "description": "Gemini 3 Flash via Venice", "cost_per_1k_tokens": 0.002},
        "grok-41-fast": {"provider": "venice", "class": VeniceModel, "description": "Grok 4.1 via Venice", "cost_per_1k_tokens": 0.010},
        "grok-code-fast-1": {"provider": "venice", "class": VeniceModel, "description": "Grok Code 1 via Venice", "cost_per_1k_tokens": 0.008},
        "zai-org-glm-4.7": {"provider": "venice", "class": VeniceModel, "description": "GLM 4.7 via Venice", "cost_per_1k_tokens": 0.002},
        "kimi-k2-thinking": {"provider": "venice", "class": VeniceModel, "description": "Kimi K2 via Venice", "cost_per_1k_tokens": 0.003},
        "minimax-m21": {"provider": "venice", "class": VeniceModel, "description": "MiniMax M2.1 via Venice", "cost_per_1k_tokens": 0.002},
        "deepseek-v3.2": {"provider": "venice", "class": VeniceModel, "description": "DeepSeek V3.2 via Venice", "cost_per_1k_tokens": 0.0003},
        "google-gemma-3-27b-it": {"provider": "venice", "class": VeniceModel, "description": "Gemma 3 27B via Venice", "cost_per_1k_tokens": 0.0006},
        "hermes-3-llama-3.1-405b": {"provider": "venice", "class": VeniceModel, "description": "Hermes 3 Llama 405B via Venice", "cost_per_1k_tokens": 0.003},
        # Legacy alias
        ...
        "llama3.3:70b": {"provider": "ollama", "class": OllamaModel, "description": "Llama 3.3 70B (local)", "cost_per_1k_tokens": 0.0},
        "llama3.2": {"provider": "ollama", "class": OllamaModel, "description": "Llama 3.2 (local)", "cost_per_1k_tokens": 0.0},
        "llama3.2:1b": {"provider": "ollama", "class": OllamaModel, "description": "Llama 3.2 1B (local)", "cost_per_1k_tokens": 0.0},
        "llama3.2:3b": {"provider": "ollama", "class": OllamaModel, "description": "Llama 3.2 3B (local)", "cost_per_1k_tokens": 0.0},
        "llama3.2-vision:11b": {"provider": "ollama", "class": OllamaModel, "description": "Llama 3.2 Vision 11B (local, multimodal)", "cost_per_1k_tokens": 0.0},
        "llama3.2-vision:90b": {"provider": "ollama", "class": OllamaModel, "description": "Llama 3.2 Vision 90B (local, multimodal)", "cost_per_1k_tokens": 0.0},
        "qwen3:235b": {"provider": "ollama", "class": OllamaModel, "description": "Qwen3 235B (local)", "cost_per_1k_tokens": 0.0},
        "qwen3:30b": {"provider": "ollama", "class": OllamaModel, "description": "Qwen3 30B MoE (local)", "cost_per_1k_tokens": 0.0},
        "qwen2.5:7b": {"provider": "ollama", "class": OllamaModel, "description": "Qwen 2.5 7B (local)", "cost_per_1k_tokens": 0.0},
        "deepseek-r1:8b": {"provider": "ollama", "class": OllamaModel, "description": "DeepSeek R1 8B (local)", "cost_per_1k_tokens": 0.0},
        "phi4:14b": {"provider": "ollama", "class": OllamaModel, "description": "Phi-4 14B (local)", "cost_per_1k_tokens": 0.0},
        "gemma2:9b": {"provider": "ollama", "class": OllamaModel, "description": "Gemma 2 9B (local)", "cost_per_1k_tokens": 0.0},
        "mistral:7b": {"provider": "ollama", "class": OllamaModel, "description": "Mistral 7B (local)", "cost_per_1k_tokens": 0.0},
        "codellama:7b": {"provider": "ollama", "class": OllamaModel, "description": "CodeLlama 7B (local)", "cost_per_1k_tokens": 0.0},
        ...
        "nanogpt/gpt-4o": {"provider": "nanogpt", "class": NanoGPTModel, "description": "GPT-4o via NanoGPT", "cost_per_1k_tokens": 0.006},
        "nanogpt/gpt-4o-mini": {"provider": "nanogpt", "class": NanoGPTModel, "description": "GPT-4o Mini via NanoGPT", "cost_per_1k_tokens": 0.0006},
        "nanogpt/claude-3-5-sonnet": {"provider": "nanogpt", "class": NanoGPTModel, "description": "Claude 3.5 Sonnet via NanoGPT", "cost_per_1k_tokens": 0.007},
        "nanogpt/claude-3-haiku": {"provider": "nanogpt", "class": NanoGPTModel, "description": "Claude 3 Haiku via NanoGPT", "cost_per_1k_tokens": 0.0006},
        "nanogpt/llama-3.1-70b": {"provider": "nanogpt", "class": NanoGPTModel, "description": "Llama 3.1 70B via NanoGPT", "cost_per_1k_tokens": 0.001},
        "nanogpt/llama-3.1-8b": {"provider": "nanogpt", "class": NanoGPTModel, "description": "Llama 3.1 8B via NanoGPT", "cost_per_1k_tokens": 0.0003},
        "nanogpt/mistral-large": {"provider": "nanogpt", "class": NanoGPTModel, "description": "Mistral Large via NanoGPT", "cost_per_1k_tokens": 0.003},
        "nanogpt/mixtral-8x7b": {"provider": "nanogpt", "class": NanoGPTModel, "description": "Mixtral 8x7B via NanoGPT", "cost_per_1k_tokens": 0.0008},
    }
