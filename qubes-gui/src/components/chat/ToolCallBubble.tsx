...
const TOOL_DISPLAY_NAMES: Record<string, string> = {
  ...
  'draft_message_variants': 'Draft Variants',
  'predict_reaction': 'Predict Reaction',
  'build_rapport_strategy': 'Build Rapport',
  // Technical Expertise Tools
  'debug_systematically': 'Debug',
  'research_with_synthesis': 'Deep Research',
  'validate_solution': 'Validate Solution',
  // Creative Expression Tools
  'brainstorm_variants': 'Brainstorm',
  'iterate_design': 'Iterate Design',
  'cross_pollinate_ideas': 'Cross-Pollinate',
  // Knowledge Domains Tools
  'deep_research': 'Deep Research',
  'synthesize_knowledge': 'Synthesize Knowledge',
  'explain_like_im_five': 'Simplify',
  // Security & Privacy Tools
  'assess_security_risks': 'Security Assessment',
  'privacy_impact_analysis': 'Privacy Analysis',
