...
def generate_all_skills() -> List[Dict[str, Any]]:
    ...
    skills.append(_create_skill("ai_reasoning_sun", "AI Reasoning", "Master AI reasoning and problem-solving capabilities", "ai_reasoning", "sun", tool_reward="describe_my_avatar", icon="🧠"))
    # Planets
    skills.append(_create_skill("prompt_engineering", "Prompt Engineering", "Craft effective prompts to elicit desired AI responses", "ai_reasoning", "planet", "ai_reasoning_sun", tool_reward="analyze_prompt_quality", icon="✍️"))
    skills.append(_create_skill("chain_of_thought", "Chain of Thought", "Break down complex problems into logical steps", "ai_reasoning", "planet", "ai_reasoning_sun", tool_reward="generate_reasoning_chain", icon="🔗"))
    skills.append(_create_skill("code_generation", "Code Generation", "Generate high-quality code across multiple languages", "ai_reasoning", "planet", "ai_reasoning_sun", tool_reward="advanced_code_gen", icon="⚙️"))
    skills.append(_create_skill("analysis_critique", "Analysis & Critique", "Critically analyze and provide constructive feedback", "ai_reasoning", "planet", "ai_reasoning_sun", tool_reward="deep_analysis", icon="🔍"))
    skills.append(_create_skill("multistep_planning", "Multi-step Planning", "Plan and execute complex multi-step tasks", "ai_reasoning", "planet", "ai_reasoning_sun", tool_reward="create_task_plan", icon="📋"))
    # Moons
    ...
    skills.append(_create_skill("empathy", "Empathy", "Understand and share feelings of others", "social_intelligence", "planet", "social_intelligence_sun", tool_reward="empathy_response", icon="🫂"))
    skills.append(_create_skill("relationship_building", "Relationship Building", "Build and maintain meaningful relationships", "social_intelligence", "planet", "social_intelligence_sun", tool_reward="relationship_strategy", icon="🌉"))
    skills.append(_create_skill("conflict_resolution", "Conflict Resolution", "Resolve conflicts peacefully and effectively", "social_intelligence", "planet", "social_intelligence_sun", tool_reward="mediation_strategy", icon="☮️"))
    # Moons
    ...
    skills.append(_create_skill("technical_expertise_sun", "Technical Expertise", "Master technical and engineering skills", "technical_expertise", "sun", tool_reward="web_search", icon="💻"))
    # Planets
    skills.append(_create_skill("programming", "Programming", "Write clean, efficient code", "technical_expertise", "planet", "technical_expertise_sun", tool_reward="code_review", icon="👨‍💻"))
    skills.append(_create_skill("devops", "DevOps", "Manage deployment and infrastructure", "technical_expertise", "planet", "technical_expertise_sun", tool_reward="infrastructure_analysis", icon="🚀"))
    skills.append(_create_skill("system_architecture", "System Architecture", "Design scalable system architectures", "technical_expertise", "planet", "technical_expertise_sun", tool_reward="architecture_design", icon="🏛️"))
    skills.append(_create_skill("debugging", "Debugging", "Identify and fix bugs efficiently", "technical_expertise", "planet", "technical_expertise_sun", tool_reward="debug_assistant", icon="🐛"))
    skills.append(_create_skill("api_integration", "API Integration", "Integrate and work with APIs effectively", "technical_expertise", "planet", "technical_expertise_sun", tool_reward="api_design", icon="🔌"))
    # Moons
    ...
    skills.append(_create_skill("creative_expression_sun", "Creative Expression", "Master creative and artistic skills", "creative_expression", "sun", tool_reward="generate_image", icon="🎨"))
    # Planets
    skills.append(_create_skill("writing", "Writing", "Write compelling, effective content", "creative_expression", "planet", "creative_expression_sun", tool_reward="writing_assistant", icon="📖"))
    skills.append(_create_skill("visual_design", "Visual Design", "Create visually appealing designs", "creative_expression", "planet", "creative_expression_sun", tool_reward="design_critique", icon="🎨"))
    skills.append(_create_skill("music", "Music", "Create and understand music", "creative_expression", "planet", "creative_expression_sun", tool_reward="music_theory", icon="🎵"))
    skills.append(_create_skill("storytelling", "Storytelling", "Craft engaging narratives", "creative_expression", "planet", "creative_expression_sun", tool_reward="story_development", icon="📚"))
    skills.append(_create_skill("creative_problem_solving", "Creative Problem Solving", "Solve problems with creative approaches", "creative_expression", "planet", "creative_expression_sun", tool_reward="ideation_assistant", icon="💡"))
    # Moons
    ...
    skills.append(_create_skill("knowledge_domains_sun", "Knowledge Domains", "Master diverse knowledge areas", "knowledge_domains", "sun", tool_reward="search_memory", icon="📚"))
    # Planets
    skills.append(_create_skill("science", "Science", "Understand scientific principles", "knowledge_domains", "planet", "knowledge_domains_sun", tool_reward="scientific_analysis", icon="🔬"))
    skills.append(_create_skill("history", "History", "Understand historical context and patterns", "knowledge_domains", "planet", "knowledge_domains_sun", tool_reward="historical_analysis", icon="📜"))
    skills.append(_create_skill("philosophy", "Philosophy", "Engage with philosophical concepts", "knowledge_domains", "planet", "knowledge_domains_sun", tool_reward="philosophical_reasoning", icon="💭"))
    skills.append(_create_skill("mathematics", "Mathematics", "Apply mathematical reasoning", "knowledge_domains", "planet", "knowledge_domains_sun", tool_reward="mathematical_solver", icon="🔢"))
    skills.append(_create_skill("languages", "Languages", "Understand and use multiple languages", "knowledge_domains", "planet", "knowledge_domains_sun", tool_reward="translation", icon="🗣️"))
    # Moons
    ...
    skills.append(_create_skill("security_privacy_sun", "Security & Privacy", "Master security and privacy protection", "security_privacy", "sun", tool_reward="browse_url", icon="🛡️"))
    # Planets
    skills.append(_create_skill("cryptography", "Cryptography", "Understand and apply cryptographic principles", "security_privacy", "planet", "security_privacy_sun", tool_reward="crypto_analysis", icon="🔐"))
    skills.append(_create_skill("authentication", "Authentication", "Implement secure authentication systems", "security_privacy", "planet", "security_privacy_sun", tool_reward="auth_design", icon="🔑"))
    skills.append(_create_skill("network_security", "Network Security", "Secure networks and communications", "security_privacy", "planet", "security_privacy_sun", tool_reward="network_analysis", icon="🛡️"))
    skills.append(_create_skill("privacy_protection", "Privacy Protection", "Protect user privacy and data", "security_privacy", "planet", "security_privacy_sun", tool_reward="privacy_audit", icon="🔒"))
    skills.append(_create_skill("threat_analysis", "Threat Analysis", "Identify and mitigate security threats", "security_privacy", "planet", "security_privacy_sun", tool_reward="threat_assessment", icon="🚨"))
    # Moons
    ...
    skills.append(_create_skill("battleship", "Battleship", "Master battleship strategy", "games", "planet", "games_sun", tool_reward="battleship_move", icon="🚢"))
    skills.append(_create_skill("poker", "Poker", "Master poker strategy and psychology", "games", "planet", "games_sun", tool_reward="poker_strategy", icon="🃏"))
    skills.append(_create_skill("tictactoe", "Tic-Tac-Toe", "Master optimal tic-tac-toe play", "games", "planet", "games_sun", tool_reward="tictactoe_move", icon="❌"))
    # Moons
